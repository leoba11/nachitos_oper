...
Thread::Thread(const char* threadName)
{
    ...
    open_files = new NachosOpenFilesTable();
    open_files->addThread();                        // agregar el hilo a la tabla de archivos abiertos
    open_semaphores = new NachosOpenFilesTable();
...
Thread::~Thread()
{
    ...
    open_files->delThread();        //Eliminar tabla
}
