...
class Thread {
  ...
  public:
    NachosOpenFilesTable* open_files; //Agregamos una tabla de archivos abiertos para cada hilo
    NachosOpenFilesTable* open_semaphores; //Agregamos una tabla de semaforos abiertos para cada hilo
