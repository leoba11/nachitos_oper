...
BitMap* MiMapa;		// Variable definition, no extern prepended, tiene que ser puntero

BitMap *TLBMap;
BitMap *SwapMap;
BitMap *MemoryMap;
TranslationEntry *invertida[NumPhysPages];
int posTLB;
int posSWAP;
int* TPI;
...
{
	//MiMapa = new BitMap(NumPhysPages);	//Se crea el bitmap de tamaño NumPhysPages:32(machine)
    int argCount;
...
// 2007, Jose Miguel Santos Espino
    ...
    SwapMap = new BitMap(64);  //swap es el doble de la memoria principal
    posSWAP = 0;
    posTLB = 0;
#endif
