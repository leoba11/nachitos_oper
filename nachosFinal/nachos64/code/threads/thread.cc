...
Thread::Thread(const char* threadName)
{
    ...
    stack = NULL;
    status = JUST_CREATED;
    open_files = new NachosOpenFilesTable();  //Se crea la tabla de archivos abiertos
    open_files->addThread();  //Se añade el hilo creado en la tabla de archivos abiertos
    open_semaphores = new NachosOpenFilesTable(); //Se crea una tabla de archivos abiertos ṕara manejar los semaforos abiertos
...
Thread::~Thread()
{
    ...
    open_files->delThread();  //Se elimina el hilo de la tabla de archivos abiertos
